    ...
    render() {
        ...
        return (
            <Card>
                ...
                <CardSection>
                    <View>
                        <Text style={styles.textStyle}>Rating: <Text style={styles.bold}>{this.props.hotel.rating}</Text></Text>
                        <Text style={styles.textStyle}>Vicinity: Rating: {this.props.hotel.vicinity}</Text>
                        <Text style={styles.textStyle}>Latitude: {this.props.hotel.geometry.location.lat} </Text>
                        <Text style={styles.textStyle}>Longitude: {this.props.hotel.geometry.location.lng}</Text>
                        <Text style={styles.textStyle}>Price per person per night: <Text style={styles.bold}>{this.state.price}</Text></Text>
                    </View>
                </CardSection>
                <CardSection>
                    <BookButton onPress={() => Actions.bookHotel({price: this.state.price, hotel: this.props.hotel})}/>
                </CardSection>
            </Card>
        );
    }
